...
- Name: Attack, Mystic Aura
   ...
   - Resource: Minor or Major
   - Mechanic: You perform your Mystic Attack on all characters within 1/2
     (Minor/Major) space(s).
   - Prerequisites: 
      + Power: Attack, Mystic
      + Role: Caster, Support
...
- Name: Attack, Mystic Cone
   - Description: You deploy resources to channel your magic in a wide blast in front of
     you.
   - Resource: Minor
...
- Name: Stealth in the Shadows
   ...
   - Tags: Stealth
- Name: Stealth's Call
   - Description: By luck or by magical effect, you know just how to distract those who
